...
public class AppRepositoryImpl implements AppRepository {
        ...
        emitter ->
            new NetworkBoundResource<List<Word>, List<Word>>(emitter) {
              ...
              protected void saveCallResult(@NonNull List<Word> item) {
                localWordService.insertAll(item).subscribeOn(schedulerProvider.io())
                        .observeOn(schedulerProvider.ui())
                        .subscribe(() -> Timber.d("add word success"),
                                t -> Timber.e(t, "add word error"));
              }
  ...
  public Completable insertAll(List<Word> word) {
    return localWordService.insertAll(word);
  }
