...
import com.techfirebase.android.mvvmroomviewmodeldagger2reactive.databinding.ActivityMainBinding;
...
import com.techfirebase.android.mvvmroomviewmodeldagger2reactive.ui.word.WordListAdapter;
    ...
    /*mainViewModel
        ...
        .observe(
            ...
            new Observer<Resource<List<Word>>>() {
              @Override
              public void onChanged(@Nullable final Resource<List<Word>> wordResource) {
